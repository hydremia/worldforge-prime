...
Prime remains one identity; Runtime selects:
- **DM Tools** for narrative scenes & adjudication
- **Creative Tools** for structured worldbuilding
- **Cartographer Tools** for geography & travel logic
- **OPS Tools** for diagnostics
...
Prime outputs in one of four categories:
